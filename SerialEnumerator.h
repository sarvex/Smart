...
#ifndef SERIAL_ENUMERATOR
#define SERIAL_ENUMERATOR
...
class SerialRegistrationWidget : public QWidget
{
    Q_OBJECT
public:
    SerialRegistrationWidget( SerialEnumerator* qese )
    {
        this->qese = qese;
    }
...
*/
class SerialEnumerator : public QObject
{
    Q_OBJECT
public:
    SerialEnumerator( );
...
private:
    ...
    /*!
             ...
             */
    static void setupAPIScan(QList<PortInformation> & infoList);
    void setUpNotificationWin( );
    static bool getDeviceDetailsWin( PortInformation* portInfo, HDEVINFO devInfo,
                                     PSP_DEVINFO_DATA devData, WPARAM wParam = DBT_DEVICEARRIVAL );
    static void enumerateDevicesWin( const GUID & guidDev, QList<PortInformation>* infoList );
...
private:
    /*!
               ...
               *    \param infoList list with result.
               */
              static void scanPortsOSX(QList<PortInformation> & infoList);
              static void iterateServicesOSX(io_object_t service, QList<PortInformation> & infoList);
              static bool getServiceDetailsOSX( io_object_t service, PortInformation* portInfo );
...
private:
    /*!
               ...
               *    \param infoList list with result.
               */
    static void scanPortsNix(QList <PortInformation> & infoList);
#endif // Q_OS_MAC
#endif /* Q_OS_UNIX */
...
public:
    /*!
        ...
        */
    static QList<PortInformation> getPorts();
    /*!
...
signals:
    /*!
        ...
        */
    void deviceDiscovered( const PortInformation & info );
    /*!
        ...
        */
    void deviceRemoved( const PortInformation & info );
};

#endif // SERIAL_ENUMERATOR
