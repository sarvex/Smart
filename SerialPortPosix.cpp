...
void SerialPort::setBaudRate(BaudRateType baudRate)
{
    ...
    if (isOpen()) {
        switch (baudRate) {
            ...
            /*50 baud*/
            case BAUD50:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows does not support 50 baud operation.");
#ifdef CBAUD
            ...
            /*75 baud*/
            case BAUD75:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows does not support 75 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
            ...
            /*134.5 baud*/
            case BAUD134:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows does not support 134.5 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
            ...
            /*150 baud*/
            case BAUD150:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows does not support 150 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
            ...
            /*200 baud*/
            case BAUD200:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows does not support 200 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
            ...
            /*1800 baud*/
            case BAUD1800:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows and IRIX do not support 1800 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
            ...
            /*14400 baud*/
            case BAUD14400:
                TTY_WARNING("SerialPort: POSIX does not support 14400 baud operation.  Switching to 9600 baud.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B9600;
#else
            ...
            /*56000 baud*/
            case BAUD56000:
                TTY_WARNING("SerialPort: POSIX does not support 56000 baud operation.  Switching to 38400 baud.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B38400;
#else
            ...
            /*76800 baud*/
            case BAUD76800:
                TTY_PORTABILITY_WARNING("SerialPort Portability Warning: Windows and some POSIX systems do not support 76800 baud operation.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
...
#else
                TTY_WARNING("SerialPort: SerialPort was compiled without 76800 baud support.  Switching to 57600 baud.");
                Posix_CommConfig.c_cflag|=B57600;
#endif //B76800
#else  //CBAUD
#ifdef B76800
            ...
            /*128000 baud*/
            case BAUD128000:
                TTY_WARNING("SerialPort: POSIX does not support 128000 baud operation.  Switching to 115200 baud.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B115200;
#else
            ...
            /*256000 baud*/
            case BAUD256000:
                TTY_WARNING("SerialPort: POSIX does not support 256000 baud operation.  Switching to 115200 baud.");
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B115200;
#else
        ...
        switch (parity) {
            ...
            case PAR_SPACE:
                if (Settings.DataBits==DATA_8) {
                    TTY_PORTABILITY_WARNING("SerialPort:  Space parity is only supported in POSIX with 7 or fewer data bits");
                }
                else {
            ...
            case PAR_MARK:
                TTY_WARNING("SerialPort: Mark parity is not supported by POSIX.");
                break;
...
void SerialPort::setStopBits(StopBitsType stopBits)
{
    ...
    if (isOpen()) {
        switch (stopBits) {
            ...
            /*1.5 stop bits*/
            case STOP_1_5:
                TTY_WARNING("SerialPort: 1.5 stop bit operation is not supported by POSIX.");
                break;
...
multithreading situations, use SerialPort::bytesWaiting() instead.
*/
