...
/*!
Default constructor.  Note that the name of the device used by a SerialPort constructed with
...
*/
SerialPort::SerialPort(SerialPort::QueryMode mode) : QIODevice()
{
...
*/
SerialPort::SerialPort(const QString & name, SerialPort::QueryMode mode)
    : QIODevice()
{
    construct();
    setQueryMode(mode);
...
*/
SerialPort::SerialPort(const PortSettings& settings, SerialPort::QueryMode mode)
    : QIODevice()
{
    construct();
...
*/
SerialPort::SerialPort(const QString & name, const PortSettings& settings, SerialPort::QueryMode mode)
    : QIODevice()
{
    construct();
    setPortName(name);
...
void SerialPort::setQueryMode(QueryMode mechanism)
{
...
*/
BaudRateType SerialPort::baudRate(void) const
{
...
*/
FlowType SerialPort::flowControl() const
{
